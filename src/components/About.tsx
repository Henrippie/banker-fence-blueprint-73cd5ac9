...
const StatCard = ({
  ...
  return <div ref={ref} className="text-center p-6 glass-card rounded-2xl animate-fade-in hover:scale-105 transition-all duration-300" style={{
...
const About = () => {
  return <section className="section-spacing bg-gradient-to-br from-muted/50 to-background">
