    ...
    <footer className="bg-primary text-primary-foreground py-8 md:py-12">
      <div className="container-section px-4">
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8 mb-6 md:mb-8">
          {/* Logo e descrição */}
          <div>
            <img src={bankerLogo} alt="Banker Sistemas" className="h-12 mb-4" />
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-primary-foreground/80">
              ...
              <li className="flex items-start gap-2">
                ...
                <span>vendas@bankersistemas.com.br</span>
              </li>
              <li className="flex items-start gap-2">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-primary-foreground/80">
              <li>CNPJ: 22.082.779/0001-74</li>
              <li>Atendimento: Seg-Sab 8h-18h</li>
              <li className="pt-2">
