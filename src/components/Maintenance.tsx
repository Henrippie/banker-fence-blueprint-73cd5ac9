...
const MaintenanceBenefit = ({
  ...
  return (
    <div
      ref={ref}
      className={`glass-card p-6 md:p-8 hover:scale-[1.02] transition-all duration-700 ${isInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
      style={{
...
const Maintenance = () => {
  ...
  const benefits = [
    ...
    },
    {
      ...
      description: "Todo serviço de manutenção conta com garantia, suporte e notas fiscais",
    },
  ];
  return (
    <section className="section-spacing bg-gradient-to-b from-background via-background/95 to-background">
      <div className="container-section">
        <div
          ref={ref}
          className={`text-center mb-16 md:mb-20 py-8 md:py-12 transition-all duration-700 ${isInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
        >
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            Se sua cerca elétrica está com problemas, desatualizada ou você simplesmente quer ter certeza de que está
            funcionando perfeitamente — nossa equipe especializada pode ajudar.
          </p>
        </div>
        ...
        >
          ...
          <div className="p-4 sm:p-6 md:p-8 bg-muted/50 backdrop-blur-sm">
            ...
            <Button
              ...
              size="lg"
              className="w-full sm:w-auto shadow-button hover:scale-105 transition-transform touch-manipulation active:scale-95"
            >
