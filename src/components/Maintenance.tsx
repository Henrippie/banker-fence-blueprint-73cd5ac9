  ...
  return (
    <section className="section-spacing bg-gradient-to-b from-background via-background/95 to-background">
      <div className="container-section">
        ...
        >
          <h2 className="heading-xl mb-4 md:mb-6">
            Mas eu já tenho uma cerca elétrica
          </h2>
        ...
        <div
          className={`relative overflow-hidden rounded-2xl transition-all duration-700 delay-300 ${
            isInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
          }`}
        >
          <OptimizedImage
