...
const CameraFinalCTA = () => {
  ...
  return <section className="section-spacing bg-gradient-to-br from-accent to-primary">
      <div className="container-section text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <Button size="lg" onClick={scrollToForm} className="bg-secondary text-secondary-foreground hover:bg-secondary/90 shadow-button text-lg px-12 py-7 transition-all duration-300 hover:scale-105">
